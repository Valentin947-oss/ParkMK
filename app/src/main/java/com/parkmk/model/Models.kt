...
object SampleData {
    ...
    val bitolaSpots = listOf(
        ParkingSpot("s1", "Sportska Sala",       "Sportski kompleks kaj Shetalishte", "zone_b1", "Зона Б1", "B", 20, 150, "07:00", "22:00", 41.022741, 21.336727),
        ParkingSpot("s2", "Aero",                "Shirok Sokak",                      "zone_b6", "Зона Б6", "B", 30,  35, "07:00", "22:00", 41.024736, 21.337873),
